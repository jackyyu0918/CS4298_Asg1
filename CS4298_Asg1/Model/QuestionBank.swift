...
class QuestionBank{
    ...
    init(){
        list.append(Question(questionText:"What is NexCalendar?", choiceA: "", choiceB: "Friday", choiceC: "Saturday", choiceD: "Sunday", answer: 1))
        ...
        list.append(Question(questionText:"Which is the benefit of using NexCalendar?", choiceA: "Monday", choiceB: "Tuesday", choiceC: "Saturday", choiceD: "31st Dec (Leap Year)", answer: 4))
